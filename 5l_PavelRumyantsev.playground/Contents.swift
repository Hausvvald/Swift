...
var mazda = sportCar(brand: "Mazda", release: 2019)
var volvo = trunkCar(brand: "Volvo", release: 2005)
mazda.changeEngineState(engineState: .on)
mazda.nitroState = .nitroOn
volvo.chageWindowsState(windowsState: .open)
volvo.trunkState = .trunkIsFull
